...
func InitAndListen(parentLog *golog.Logger) (app *fiber.App, err error) {
	...
	apiV1Projects.Get("/:id/resources", getProjectResources)
	apiV1Projects.Post("/:id/resources", postCreateProjectResource)
	apiV1Projects.Patch("/:id/resources/:resourceID", patchProjectResource)
	...
	apiV1Projects.Post("/:id/asset-assignments", postCreateProjectAssetAssignment)
	apiV1Projects.Delete("/:id/asset-assignments/:assignmentID", deleteProjectAssetAssignment)
	...
	apiV1Projects.Get("/:id/deployments", getProjectDeployments)
	apiV1Projects.Post("/:id/deployments", postProjectDeployment)
